  ...
  return <>
    ...
    <header className="border-b-4 border-oxide bg-white px-4 py-4 shadow-md">
      <div className="mx-auto flex max-w-7xl justify-center">
        <Link href="/" aria-label="Rugged American Exteriors home" className="inline-flex rounded-sm bg-white p-2">
          <Image src="/rugged-american-exteriors-logo-transparent.png" alt="Rugged American Exteriors" width={2058} height={764} priority className="h-16 w-auto sm:h-20"/>
        </Link>
      </div>
    </header>
